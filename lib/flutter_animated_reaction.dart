...
class AnimatedFlutterReaction {
  ...
  void showOverlay({
    ...
    const barH = 60.0; // نفس constraints عندك
    const gap = 10.0; // مسافة صغيرة بين الزر والبار
    const margin = 8.0; // عشان مايلزقش في الحواف
    ...
    // امنع البار يدخل في النوتش/الجستشر بار
